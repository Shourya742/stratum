...
impl ParseMiningMessagesFromDownstream<()> for Downstream {
    ...
    fn handle_submit_shares_standard(
        ...
        let last_new_prev_hash = self.last_new_prev_hash.clone();
        ...
        let res = standard_channel.validate_share(m.clone(), chain_tip);
        match res {
    ...
    fn handle_submit_shares_extended(
        ...
        let res = extended_channel.validate_share(m.clone(), chain_tip);
        match res {
            Ok(ShareValidationResult::Valid) => {
                info!(
