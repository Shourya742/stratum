...
use crate::{
    channel_management::{
        extended_channel::ExtendedChannel, ShareValidationError, ShareValidationResult,
    },
    mining_sv2::{
        ExtendedExtranonce as ExtendedExtranonceFactory, ExtendedExtranonceError,
        OpenExtendedMiningChannel, SetCustomMiningJob, SetNewPrevHash, SubmitSharesExtended,
...
///   - [`SetNewPrevHash`] or [`SetNewPrevHashTDP`] (update channel chain tip)
